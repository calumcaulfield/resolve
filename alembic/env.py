...
there is exactly one source of truth for it and no chance of migrations
running against a different database than the application.
"""
...
from resolve.db import models  # noqa: F401 - registers the tables
